...
namespace SixCloudCore.FileUploader
{
    internal sealed class SimpleUploadWorker
    {
        ...
        private readonly ConcurrentQueue<SimpleUploadTask> workbook = new ConcurrentQueue<SimpleUploadTask>();

        private readonly SimpleUploadTask[] runningTasks = new SimpleUploadTask[MaximumParallelTask];
